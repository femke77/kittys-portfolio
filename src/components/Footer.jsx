        ...
        <footer className="fixad bottom-0 bg-blueGray-200 pt-8 pb-6 ">
          <div className="container mx-auto px-4">
            <div className="flex flex-wrap text-left lg:text-left">
              <div className="w-full lg:w-6/12 px-4">
                ...
                <h5 className="text-lg mt-0 mb-2 text-blueGray-600">
                  Find me on any of these platforms, I am a very busy cat, but I respond in 1-2 business days.
                </h5>
                <div className="mt-6 lg:mb-0 mb-6">
                  <button className="bg-white text-lightBlue-400 shadow-lg font-normal h-10 w-10 items-center justify-center align-center rounded-full outline-none focus:outline-none mr-2" type="button">
                    ...
                    <i className="fab fa-linkedin"></i></button><button className="bg-white text-blueGray-800 shadow-lg font-normal h-10 w-10 items-center justify-center align-center rounded-full outline-none focus:outline-none mr-2" type="button">
            ...
            <div className="flex flex-wrap items-center md:justify-between justify-center">
              <a href="https://www.github.com/femke77">See my github (test)</a>
